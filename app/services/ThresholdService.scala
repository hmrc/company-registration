...
import utils.{CurrencyFormatter, Logging}

@Singleton
class ThresholdService @Inject()()(implicit microserviceAppConfig: MicroserviceAppConfig) extends Logging {

  def now: LocalDateTime = LocalDateTime.now()


   def getVatThreshold: Option[VatThreshold] = {
    val currentVatThreshold = {
      microserviceAppConfig.thresholds
  ...
  def formattedVatThreshold: String = {
