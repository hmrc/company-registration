...
class CorporationTaxRegistrationMongoRepositorySpec extends UnitSpec with BeforeAndAfterEach with ScalaFutures with Eventually with WithFakeApplication {
