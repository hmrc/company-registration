...
class CorporationTaxRegistrationRepositorySpec extends UnitSpec  with MongoMocks with MockitoSugar with BeforeAndAfter with CorporationTaxRegistrationFixture {
//
